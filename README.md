...
> For this, you can download the script and run it manually after inspecting it.
>
> ```
...
If you want to clone the repository and setup the WebUI library in a local directory and run the examples:
